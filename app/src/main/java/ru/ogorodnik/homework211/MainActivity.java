package ru.ogorodnik.homework211;
...
// Нажатие кнопки OK ---------------------------------------------------------------------
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, txtMessage + " в размере " + mInputMoney.getText() + " рублей", Toast.LENGTH_LONG).show();
            }
        });
    }
